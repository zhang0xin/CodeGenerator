...
public class DepartmentParamsAuto extends BaseQueryParams {
  ...
  private LongQueryParameter studentCount = new LongQueryParameter();
  
  private StringQueryParameter name = new StringQueryParameter();
  
  private DateQueryParameter dt = new DateQueryParameter();
  ...
  public LongQueryParameter getStudentCount() {
    return studentCount;
  }
  public void setStudentCount(LongQueryParameter studentCount) {
  ...
  public DateQueryParameter getDt() {
    return dt;
  }
  public void setDt(DateQueryParameter dt) {
    this.dt = dt;
  }
