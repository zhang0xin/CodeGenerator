...
public class DepartmentUi extends DepartmentUiAuto {
  // F0
  ...
  /*public String createF0DataDridColumn(){
    return f0.textColumn().toString();
  }*/
  ...
  /*public String createDepartmentIdDataDridColumn(){
    return departmentId.textColumn().toString();
  }*/
  ...
  /*public String createStudentCountDataDridColumn(){
    return studentCount.textColumn().toString();
  }*/
  ...
  /*public String createNameDataDridColumn(){
    return name.textColumn().toString();
  }*/
  ...
  /*public String createDtDataDridColumn(){
    return dt.dateColumn().toString();
  }*/
  ...
  /*public String createCreateByDataDridColumn(){
    return createBy.textColumn().toString();
  }*/
  ...
  /*public String createCreateDateDataDridColumn(){
    return createDate.datetimeColumn().toString();
  }*/
  ...
  /*public String createUpdateByDataDridColumn(){
    return updateBy.textColumn().toString();
  }*/
  ...
  /*public String createUpdateDateDataDridColumn(){
    return updateDate.datetimeColumn().toString();
  }*/
  ...
  /*public String createArchivedDataDridColumn(){
    return archived.textColumn().toString();
  }*/
